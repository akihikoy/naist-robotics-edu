...
int main()
{
  ...
  AL::ALValue names= AL::ALValue::array("LHand","RHand");
  AL::ALValue angle_lists;
  angle_lists.arraySetSize(2);
  angle_lists[0]= AL::ALValue::array(1.0, 0.0, 0.5);
  angle_lists[1]= AL::ALValue::array(0.0, 1.0, 0.5);
  AL::ALValue time_lists;
  time_lists.arraySetSize(2);
  time_lists[0]= AL::ALValue::array(1.0, 2.0, 3.0);
  time_lists[1]= AL::ALValue::array(1.0, 2.0, 3.0);
